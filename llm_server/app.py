...
parser.add_argument(
    "--provider",
    type=str,
    help="LLM backend library to use. set to [ollama], [vllm] or [llamacpp]",
    required=True,
)
...
assert args.provider in [
    "ollama",
    "llamacpp",
], f"Provider {args.provider} does not exists. see --help for more information"
